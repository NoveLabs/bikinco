	...
	<div id="sc-page-content">
		<div class="uk-flex-center" data-uk-grid>
			<div class="uk-width-2-3@l">
                ...
                <input name="edit-vendors-id" value="{{ $data->id }}" required type="hidden" >
				<div class="uk-card">
					...
					<div class="uk-card-body">
                        ...
                        <div class="uk-grid" data-uk-grid="">
                            <div class="uk-width-1-2@l uk-width-1-1@s">
                                ...
                                <input class="uk-input" name="vendor_name" value="{{ $data->vendor_name }}" required type="text" data-sc-input="outline">
                            </div>
                            <div class="uk-width-1-2@l uk-width-1-1@s">
                                <label><div class="custom-form-labeller"><span>Admin / Owner</span> <span class="custom-important-input"><sup>*</sup></span></div></label>
                                <input class="uk-input" name="owner_name" value="{{ $data->owner_name }}" required type="text" data-sc-input="outline">
                            </div>
                        </div>
                        <div class="uk-grid" data-uk-grid="">
                            <div class="uk-width-1-2@l uk-width-1-1@s">
                            ...
                            <div class="uk-width-1-2@l uk-width-1-1@s">
                                ...
                                <input class="uk-input" name="contact" value="{{ $data->contact }}" required type="number" data-sc-input="outline">
                            </div>
                        </div>
                        <div class="uk-grid" data-uk-grid>
                            <div class="uk-width-1-2@l uk-width-1-1@s">
                                <label><div class="custom-form-labeller"><span>Website</span></span></div></label>
                                <input class="uk-input" name="website" value="{{ $data->website }}" type="url" data-sc-input="outline">
                            </div>
                        </div>
                        <div class="uk-grid" data-uk-grid>
                            <div class="uk-width-1-1@l uk-width-1-1@s">
                                ...
                                <select name="product[]" id="products" required multiple class="uk-select" data-sc-select2='{"placeholder": "Pilih produk yang dapat dilayani", "allowClear": true }'>
                        ...
                        <div>
                            <p class="uk-text-left">
                                ...
                                <a href="{{ route('vendors') }}" class="sc-button  sc-button-flat sc-button-flat-danger uk-modal-close">Kembali</a>
                            </p>
                        </div>
					</div>
				</div>
...
<script>
	...
	$(document).ready(function () {
        ...
        $("#products").val(@php echo json_encode($productList); @endphp).change();

        //Add action
        $('#edit_form').submit(function(event){
            event.preventDefault();

            var id = $("input[name=edit-vendors-id]").val();
