    ...
    <div id="sc-page-content">
        <div class="uk-alert-icon" data-uk-alert>
            ...
            <div class="uk-flex uk-flex-middle">
                ...
                <div class="uk-alert-content">
                    <h5>Pada halaman ini terdapat data master posisi artwork produk dari Bikin-co</h5>
                    <p>Anda dapat menambah, mengedit dan menghapus data spesifikasi sesuai kebutuhan Anda.</p>
                </div>
            </div>
        </div>
        ...
        <div class="uk-card uk-margin">
            <div class="uk-flex-middle sc-padding sc-padding-medium-ends uk-grid-small" data-uk-grid>
                <div class="uk-flex-1">
                    <h3 class="uk-card-title">Data Master Posisi Artwork</h3>
                </div>
            ...
            <div class="uk-card-body">
                <table id="artworks-table" class="artworks-table uk-table uk-table-striped dt-responsive">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th></th>
...
<div id="add-modal" data-uk-modal>
    <div class="uk-modal-dialog">
        ...
        <div class="uk-modal-header">
            <h2 class="uk-modal-title">Input Data Posisi Artwork</h2>
        </div>
    ...
    <div class="uk-modal-dialog">
                    ...
                    <div class="custom-detail-list-box">
                        ...
                        <ul class="uk-list custom-inline-list">
                            ...
                            <div>
                                ...
                                <input type="checkbox" name="detail-status" value="1" data-sc-switchery checked /><label class="uk-margin-small-left">Aktif / Non Aktif</label>
                            </div>
                        </ul>
                    </div>
                </div>
        ...
        <div class="uk-modal-footer uk-text-right">
            <form action="" style="width: 100px;">
                <a id="sc-js-modal-confirm" style="margin-right: 66%;" class="delete-artworks uk-text-left sc-button sc-button-danger sc-js-button-wave-light" href="#">Hapus</a>
            </form>
            <button class="sc-button sc-button-flat sc-button-flat-danger uk-modal-close" type="button">Batal</button>
...
<script>
    function showDetail(id)
    {
        ...
        $.ajax({
            ...
            success: function (data) {
                ...
                $("input[name=edit-artworks-id]").val(data.data.id);
                ...
                $(".delete-artworks").attr('data-id', id);
            },
            error: function (data) {
	...
	$(document).ready(function () {
        ...
        var table = $('#artworks-table').DataTable({
            processing: true,
            serverSide: true,
            retrieve: true,
            pageLength: 10,
            ...
            columns: [
                ...
                {data: 'name', name: 'name', title: 'Nama Posisi Artwork'},
        ...
        //Delete action
        $('.delete-artworks').on('click', function (e) {
			UIkit.modal.confirm('Apakah anda yakin akan menghapus data ini ?').then(function () {
                e.preventDefault();

                var params = {
                    _token: '{{ csrf_token() }}',
                    id: $(".delete-artworks").attr('data-id'),
                }

                $.ajax({
                    type: "DELETE",
                    url: "{{ route('artworks.delete') }}",
                    data: params,
                    async: false,
                    success: function (data) {
        ...
        $('#edit_form').submit(function(event) {
            ...
            var id = $("input[name=edit-artworks-id]").val();
