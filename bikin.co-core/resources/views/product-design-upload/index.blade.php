      ...
      <div class="uk-overflow-auto">
        <table class="uk-table uk-table-divider" id="ts-issues">
          ...
          <tbody>
            ...
            <tr>
                <td>
                    <a href="{{ url('pd_upload/'.$data[$i]->id) }}" data-uk-toggle class="sc-button sc-button-mini sc-button-success">Detail</a>
                </td>
                <td>
                    <a style="margin-top: 5px;" href="#modal-track-order{{ $data[$i]->id }}" onclick="trackOrder({{ $data[$i]->id }})" data-uk-toggle class="sc-button sc-button-mini">TRACK ORDER</a>
					<div style="margin-top: 10px;">
                        <a href="sales-officer/printable/spk/customer/{{ $data[$i]->id }}?action=export" target="blank"
                           class="sc-button sc-button-mini">SPK CUSTOMER</a>
                        <a href="sales-officer/printable/spk/vendor/{{ $data[$i]->id }}?action=export" target="blank"
				...
				<td>
					@if ($data[$i]->status == 1)
					<span class="uk-label uk-label-danger">Segera Direspon</span>
