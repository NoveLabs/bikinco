            ...
            <div class="uk-overflow-auto">
                <table class="uk-table uk-table-divider" id="ts-issues">
                    ...
                    <tr role="row "class="odd">
                        ...
                        <td>
                        @if ($data[$i]->proof_payment_pelunasan == null)
                            <span class="uk-label uk-label-danger">Belum diunggah</span>
                        @else
                            <span class="uk-label uk-label-success">Sudah Diunggah</span>
                        @endif
                        </td>
                    </tr>
                    @endfor
...
<div id="modal-upload-bukti-transfer{{ $data[$i]->id }}" data-uk-modal>
    <div class="uk-modal-dialog">
        ...
        <div class="uk-modal-body" data-uk-overflow-auto>
            ...
            <form action="{{ route('upload_img_vendor.addPelunasan') }}" method="post" id="form" enctype="multipart/form-data">
            {{csrf_field()}}
...
<div id="modal-view-image{{$data[$i]->id}}" class="uk-flex-top" data-uk-modal>
    <div class="uk-modal-dialog uk-width-auto uk-margin-auto-vertical">
        ...
        <img style="max-height: 600px;" src="{{$data[$i]->proof_payment_pelunasan}}" alt="">
        <div style="margin: 15px;">
            <p>Diunggah pada {{ $data[$i]->tgl_payment }} Pukul {{ $data[$i]->log_created_time }} </p>
        </div>
