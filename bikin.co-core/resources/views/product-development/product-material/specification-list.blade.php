    ...
    <div id="sc-page-content">
        <div class="uk-alert-icon" data-uk-alert>
            ...
            <div class="uk-flex uk-flex-middle">
                ...
                <div class="uk-alert-content">
                    <h5>Pada halaman ini terdapat data master spesifikasi material dari Bikin-co</h5>
                    <p>Anda dapat menambah, mengedit dan menghapus data spesifikasi material sesuai kebutuhan Anda.</p>
                </div>
            </div>
        </div>
        ...
        <div class="uk-card uk-margin">
            <div class="uk-flex-middle sc-padding sc-padding-medium-ends uk-grid-small" data-uk-grid>
                <div class="uk-flex-1">
                    <h3 class="uk-card-title">Data Master Spesifikasi Material</h3>
                </div>
                    ...
                    <div class="uk-dropdown uk-width-small" data-uk-drop="mode: click">
                        <div class="sc-padding-small hide-columns-">
                            ...
                            <div class="uk-margin-small">
                                ...
                                <label for="sc-dt-col-1">Nama Spesifikasi</label>
                            </div>
                            <div class="uk-margin-small">
...
<div id="add-modal" data-uk-modal>
    <div class="uk-modal-dialog">
        ...
        <div class="uk-modal-header">
            <h2 class="uk-modal-title">Input Data Spesifikasi</h2>
        </div>
...
<div id="edit-modal" data-uk-modal>
    <div class="uk-modal-dialog">
        <button class="uk-modal-close-default" type="button" data-uk-close></button>
        <div class="uk-modal-header">
            <h2 class="uk-modal-title">Detail Spesifikasi</h2>
        </div>
        <form enctype="multipart/form-data" id="edit_form" role="form" method="POST" action="">
            ...
            <div class="uk-modal-body uk-padding-remove-top">
                ...
                <div class="uk-grid" data-uk-grid>
                    <div class="uk-width-1-1@l">
                        <label>Nama Spesifikasi<sup>*</sup></label>
                        <input type="text" name="name" required class="uk-input data-spec-name" value="Fashion"
                               data-sc-input>
                    </div>
                    <div class="uk-width-1-1@l">
                    ...
                    <div class="uk-width-1-1@l">
                        <div class="uk-grid" data-uk-grid>
                            <div class="uk-width-1-2@l uk-width1-2@s">
                                <a id="sc-js-modal-confirm" style="margin-right: 66%;"
                                   class="delete-specifications uk-text-left" href="#">
                                    <button type="button" class="sc-button sc-button-danger sc-js-button-wave-light">
                                        Hapus
                                    </button>
                                </a>
                            </div>
...
<script>
	...
	$(document).ready(function () {
        ...
        var table = $('#specifications-table').DataTable({
            ...
            retrieve: true,
            pageLength: 10,
            ajax: "{{ route('specifications') }}",
            columns: [
                {data: 'id', name: 'id', title: 'ID Spesifikasi'},
        ...
        $('.delete-specifications').on('click', function (e) {
			UIkit.modal.confirm('Apakah anda yakin akan menghapus data ini ?').then(function () {
                ...
                $.ajax({
                    type: "DELETE",
                    url: "{{ route('specifications.delete') }}",
                    data: params,
                    async: false,
                    success: function (data) {
