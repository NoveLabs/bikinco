    ...
    <div id="sc-page-content">
        <div class="uk-alert-icon" data-uk-alert>
            ...
            <div class="uk-flex uk-flex-middle">
                ...
                <div class="uk-alert-content">
                    <h5>Pada halaman ini terdapat data master spesifikasi item dari Bikin-co</h5>
                    <p>Anda dapat menambah, mengedit dan menghapus data spesifikasi item sesuai kebutuhan Anda.</p>
                </div>
            </div>
        </div>
        ...
        <div class="uk-card uk-margin">
            <div class="uk-flex-middle sc-padding sc-padding-medium-ends uk-grid-small" data-uk-grid>
                <div class="uk-flex-1">
                    <h3 class="uk-card-title">Data Master Spesifikasi Item</h3>
                </div>
                    ...
                    <div class="uk-dropdown uk-width-small" data-uk-drop="mode: click">
                        <div class="sc-padding-small hide-columns-">
                            ...
                            <div class="uk-margin-small">
                                ...
                                <label for="sc-dt-col-1">Nama Spesifikasi item</label>
                            </div>
                            <div class="uk-margin-small">
                            ...
                            <div class="uk-margin-small">
                                ...
                                <label for="sc-dt-col-2">Material Item</label>
                            </div>
                            <div class="uk-margin-small">
                            ...
                            <div class="uk-margin-small">
                                <input type="checkbox" name="check_5" class="hide-column" data-column="5" value="5"
                                       checked>
            ...
            <div class="uk-card-body">
                <table id="specification-items-table" class="specification-items-table uk-table uk-table-striped dt-responsive">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama Spesifikasi item</th>
                            <th>Spesifikasi</th>
                            <th>Material</th>
                            <th>Status</th>
                            <th>Aksi</th>
...
<div class="sc-fab-card-wrapper uk-position-bottom-right">
    <a href="#" onclick="$('#add_form').trigger('reset');$('select[name=material_specification_id]').val('').change();" class="sc-fab sc-fab-text sc-fab-success" data-uk-toggle="target: #add-modal"><i class="mdi mdi-plus"></i>Tambahkan</a>
</div>
...
<div id="add-modal" data-uk-modal>
    <div class="uk-modal-dialog">
        ...
        <div class="uk-modal-header">
            <h2 class="uk-modal-title">Input Data Spesifikasi Item</h2>
        </div>
            ...
            <div class="uk-modal-body uk-padding-remove-top">
                <div class="uk-grid" data-uk-grid>
                    <div class="uk-width-1-1@l">
                        <label>Nama Warna Item<sup>*</sup></label>
                    ...
                    <div class="uk-width-1-1@l">
                        ...
                        <div class="uk-width-expand">
                            <select name="material_specification_id" required class="uk-select"
                    ...
                    <div class="uk-width-1-1@l">
                        ...
                        <div class="uk-width-expand">
                            <select name="material_item_id" required class="uk-select material_item_id"
                                    data-sc-select2='{"placeholder": "Pilih Kategori", "allowClear": true }' required>
                    ...
                    <div class="uk-width-1-1@l">
                        <label>Status Spesifikasi Item<sup>*</sup></label> <br>
...
<div id="edit-modal" class="modal-close data_subcategory" data-uk-modal>
    <div class="uk-modal-dialog">
        <button class="uk-modal-close-default" type="button" data-uk-close></button>
        <div class="uk-modal-header">
            <h2 class="uk-modal-title">Detail Spesifikasi Item</h2>
        </div>
        <form enctype="multipart/form-data" id="edit_form" role="form" method="POST" action="">
            <input type="hidden" name="edit-specification-items-id">
            <div class="uk-modal-body uk-padding-remove-top">
                <div class="uk-grid" data-uk-grid>
                    <div class="uk-width-1-1@l">
                        <ul class="uk-list">
                    ...
                    <div class="uk-width-1-1@l">
                        <label>Nama Spesifikasi Item<sup>*</sup></label>
                        <input type="text" name="name" required class="uk-input data-spec-name" value="Kaos"
                               data-sc-input>
                    </div>
                    <div class="uk-width-1-1@l">
                        <label class="custom-form-label">Spesifikasi<sup>*</sup></label>
                        <div class="uk-width-expand">
                            <select name="material_specification_id" required id="material_specification_id"
                                    class="uk-select"
                    ...
                    <div class="uk-width-1-1@l">
                        <label class="custom-form-label">Material Itam<sup>*</sup></label>
                        <div class="uk-width-expand">
                            <select name="material_item_id" required id="material_specification_id"
                                    class="uk-select"
                                    data-sc-select2='{"placeholder": "Pilih Spesifikasi", "allowClear": true }'
                                    required>
                                <option value="0">Pilih Spesifikasi</option>
                    ...
                    <div class="uk-width-1-1@l">
                        <label for="subcategory-stats">Status Spesifikasi Item<sup>*</sup></label><br>
            ...
            <div class="uk-modal-footer">
                <div class="uk-grid" data-uk-grid>
                    <div class="uk-width-1-2@l uk-width-1-2@s">
                        <button class="sc-button sc-button-danger delete-specification-items" type="button">Hapus</button>
                    </div>
                    <div class="uk-width-1-2@l uk-width-1-2@s">
...
<script>
    function showDetail(id)
    {
        ...
        $.ajax({
            type: "GET",
            url: 'specification-items/' + id,
            success: function (data) {
                var status = data.data.status == 1 ? 'Aktif' : 'Tidak aktif';

                //Set up data for edit modal
                $("input[name=edit-specification-items-id]").val(data.data.id);
                $("input[name=name]").val(data.data.name);
                $("select[name=material_specification_id]").val(data.data.material_specification_id).change();
                ...
                let dataSpecName = $(".data-spec-name");
                dataSpecName.parent().addClass('sc-input-filled');

                //Set up credentials for edit and delete action...
                $(".delete-specification-items").attr('data-id', id);
            },
            error: function (err) {
	...
	$(document).ready(function () {
        ...
        var table = $('#specification-items-table').DataTable({
            processing: true,
            serverSide: true,
            retrieve: true,
            pageLength: 10,
            ajax: "{{ route('specification-items') }}",
            columns: [
                {data: 'id', name: 'id', title: 'ID Spesifikasi Item'},
                {data: 'name', name: 'name', title: 'Nama Spesifikasi Item'},
                {data: 'alias_specification', name: 'hasSpecification.name', title: 'Spesifikasi'},
                {data: 'alias_material_item', name: 'hasProductMaterialItem.name', title: 'Material Item'},
        ...
        //Delete action
        $('.delete-specification-items').on('click', function (e) {
			UIkit.modal.confirm('Apakah anda yakin akan menghapus data ini ?').then(function () {
                e.preventDefault();

                var params = {
                    _token: "{{ csrf_token() }}",
                    id: $(".delete-specification-items").attr('data-id'),
                }

                $.ajax({
                    type: "DELETE",
                    url: "{{ route('specification-items.delete') }}",
                    data: params,
                    async: false,
                    success: function (data) {
        ...
        $('#edit_form').submit(function(event) {
            ...
            var id = $("input[name=edit-specification-items-id]").val();
            var status = $("input[name=detail-status]:checked").val() == 1 ? 1 : 0;

            var material_specification_id = 0;
            $.each($("#material_specification_id option:selected"), function () {
                material_specification_id = $(this).val();
            });

            var formDataE = new FormData(this);
            formDataE.append('_token', "{{ csrf_token() }}");
            formDataE.append('material_specification_id', material_specification_id);
        ...
        $('#add_form').submit(function(event){
            ...
            $.ajax({
                type: 'POST',
                url: "{{ route('specification-items.add') }}",
                data: formData,
                cache: false,
                contentType: false,
                processData: false,
    ...
    // loadSelectContent
    function loadSelectContent(data) {
        let source = $('.material_item_id');

        $(source).empty();
        $(source).append("<option value='0'>Pilih Material Item</option>");

        let ajax = {
            type: 'GET',
            url: "specification-items/get-material-items/" + data,
            success: function (response) {
                let res_data = response.data;
                for (let i in res_data) {
                    if (res_data.hasOwnProperty(i)) {
                        let out = "<option value='" + res_data[i].id + "'>" + res_data[i].name + "</option>";
                        $(source).append(out);
                    }
                }
            },
