    ...
    <div id="sc-page-content">
        <div class="uk-alert-icon" data-uk-alert>
            ...
            <div class="uk-flex uk-flex-middle">
                ...
                <div class="uk-alert-content">
                    <h5>Pada halaman ini terdapat data master metode cetak dari Bikin-co</h5>
                    <p>Anda dapat menambah, mengedit dan menghapus data metode cetak sesuai kebutuhan Anda.</p>
                </div>
            </div>
        </div>
        ...
        <div class="uk-card uk-margin">
            <div class="uk-flex-middle sc-padding sc-padding-medium-ends uk-grid-small" data-uk-grid>
                <div class="uk-flex-1">
                    <h3 class="uk-card-title">Data Master Metode Cetak</h3>
                </div>
            </div>
            <hr class="uk-margin-remove">
            <div class="uk-card-body">
                <table id="printMethod-tabel" class="printMethod-tabel uk-table uk-table-striped dt-responsive">
                    <thead>
                        <tr>
                            <th>No</th>
                            <th>Nama</th>
...
<div id="add-modal" data-uk-modal>
    <div class="uk-modal-dialog">
        ...
        <div class="uk-modal-header">
            <h2 class="uk-modal-title">Input Data metode cetak</h2>
        </div>
    ...
    <div class="uk-modal-dialog">
        ...
        <form action="" enctype="multipart/form-data" method="" role="" id="edit_form">
            <div class="uk-modal-body uk-padding-remove-topK">
                ...
                <input type="hidden" name="edit-print_method-id"/>
                <div class="uk-grid" data-uk-grid>
                    <div class="uk-width-1-1@l">
                        <label>Nama <sup>*</sup></label>
...
<script>
	...
	$(document).ready(function () {
        ...
        var table = $('#printMethod-tabel').DataTable({
            processing: true,
            serverSide: true,
            retrieve: true,
            pageLength: 10,
            ajax: "{{ route('printMethod.index') }}",
            columns: [
        ...
        $('#edit_form').submit(function(event) {
            ...
            var id = $("input[name=edit-print_method-id]").val();
