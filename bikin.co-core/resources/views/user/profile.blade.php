                        ...
                        <div class="uk-card"">
                            <div class="uk-card-body">
                                <div class="uk-text-center">
                                    <div class="sc-user-profile-avatar fileinput fileinput-exists uk-margin-bottom" data-provides="fileinput">
                                    ...
                                    <span class="sc-color-secondary">{{ implode(', ', $data) }}</span>
                                </div>
