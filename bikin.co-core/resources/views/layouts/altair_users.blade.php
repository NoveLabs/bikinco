    ...
    <aside id="sidebar_main">
        ...
        <div class="menu_section">
            <ul>
                ...
                <li class="{{ request()->is('order_payment/*') || request()->is('order_pelunasan_payment/*') || request()->is('order_item_step/*')  == true ? 'submenu_trigger current_section act_section' : '' }}" title="Product">
                        <a href="#">
                        ...
                        <ul class="sc-sidebar-menu-sub" style="display: none;">
                            <li>
                                <a href="">Buat Order Baru</a>
                            </li>
                            <li>
                                <a href="so-product-order-waiting-customer.html">Menunggu Konfirmasi</a>
                            </li>
                            <li class="{{ request()->is('order_payment*') ? 'current_section' : '' }}">
                                <a href="{{ route('order_payment-index')}}">Menunggu Pembayaran<div id="jumlah_belum_konfirmasi"></div></a>
                            </li>
                            <li>
                                <a href="so-product-order-waiting-artwork.html">Verifikasi Artwork</a>
                            </li>
                            <li class="{{ request()->is('order_item_step*') ? 'act_item' : '' }}">
                                <a href="{{ route('order_item_step.index') }}">Diproses</a>
                            </li>
                            <li class="{{ request()->is('order_pelunasan_payment*') ? 'current_section' : '' }}">
                                <a href="{{ route('order_pelunasan_payment-index')}}">Menunggu Pelunasan<div id="jumlah_belum_konfirmasi_pelunasan"></div></a>
                            </li>
                            <li>
                                <a href="so-product-order-shipment.html">Order Dikirim</a>
                            </li>
                            <li>
                                <a href="so-product-order-done.html">Order Selesai</a>
                            </li>
                        </ul>
                    </li>
                @endif
                @if(in_array("3", $userRoles))
                   <li class="{{ request()->is('order/item/step/*') ||  request()->is('shipment/list/*') || request()->is('order/selesai/produksi/*') || request()->is('qc_complain/*')  == true ? 'submenu_trigger current_section act_section' : '' }}">
                        <a href="#">
                            <span class="uk-nav-icon"><i class="mdi mdi-basket"></i></span>
                            <span class="uk-nav-title">Order Produk</span>
                        </a>
                        <ul class="sc-sidebar-menu-sub" style="display: none;">
                            <li class="{{ request()->is('order/item/step*') ? 'current_section' : '' }}">
                                <a href="{{ route('order_item_step.index') }}">Diproses</a>
                            </li>
                            <li class="{{ request()->is('order/selesai/produksi*') ? 'current_section' : '' }}">
                                <a href="{{ route('order_selesai_produksi.index') }}">Selesai Produksi</a>
                            </li>
                            <li class="{{ request()->is('shipment/list*') ? 'current_section' : '' }}">
                                <a href="{{ route('ready_shipment.listQc') }}">Siap Dikirim</a>
                            </li>
                        </ul>
                    </li>
                <li title="Dalam Komplain" class="{{ request()->is('qc_complain*') ? 'current_section' : '' }}">
                ...
                @if (in_array("2", $userRoles))
                <li title="Dalam Komplain">
                    <a href="../so-product-order-complain.html">
                        <span class="menu_icon"><i class="material-icons">feedback</i></span>
                        <span class="menu_title">Dalam Komplain</span>
                    </a>
                </li>
                <hr>
                <li title="Data Pelanggan">
                    <a href="#">
                        <span class="menu_icon"><i class="material-icons">group</i></span>
                        <span class="menu_title">Data Pelanggan</span>
                    </a>
                    <ul>
                        <li>
                            <a href="../so-customer-lists.html">Semua Pelanggan</a>
                        </li>
                        <li>
                ...
                <li title="Data Vendor">
                    <a href="#">
                        <span class="menu_icon"><i class="material-icons">domain</i></span>
                        <span class="menu_title">Data Vendor</span>
                    </a>
                    <ul>
                        <li>
                            <a href="../so-vendor-lists.html">Semua Vendor</a>
                        </li>
                        <li>
                            <a href="../so-vendor-blast.html">Sebar Informasi</a>
                        </li>
                    </ul>
                </li>
                <hr>
                <li title="Statistik & Laporan">
                    <a href="#">
                        <span class="menu_icon"><i class="material-icons">show_chart</i></span>
                        <span class="menu_title">Statistik & Laporan</span>
                    </a>
                    <ul>
                        <li>
