    ...
    <div id="sc-page-top-bar" class="sc-top-bar uk-flex-middle">
        <div class="sc-top-bar-content sc-padding-medium-ends uk-flex-1">
            <div class="uk-flex uk-flex-column uk-flex-1">
                <h1 class="sc-top-bar-title uk-text-uppercase uk-margin-small-bottom">Daftar Order Sukses</h1>
            ...
            <tr>
                <td>
                    <a style="margin-top: 5px;"
                       href="{{ route('qc.printable.shipment-receipt', $value->id) }}?action=export" target="_blank"
                       data-uk-toggle class="sc-button sc-button-mini">NO RESI</a>
                    ...
                    <a style="margin-top: 5px;" href="{{ route('so.printable.inv.dp.paid', $value->id) }}?action=export"
                       target="_blank" class="sc-button sc-button-mini">Nota DP</a>
                </td>
