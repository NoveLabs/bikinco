                            ...
                            <div class="page-card no-margin-right">
                                ...
                                <div class="card-footer official-background">
                                    <ul class="page-list text-left">
                                        <li class="list-grid-12">
                                            <ul class="page-list">
                                                <li class="list-grid-6">{{ $orders[0]->part_paid_amount == 0 ? 'Pembayaran Penuh' : 'Pembayaran DP' }}</li>
                ...
                <div class="how-to-pay">
                    ...
                    <div class="how-to-pay" style="padding: 4mm; background: #eaeaea">
                        ...
                        <div class="default-margin-bottom">
                            ...
                            <span class="text-default">1. Produk akan dikirimkan setelah Pelunasan terverifikasi.</span><br>
                            <span class="text-default">2. Untuk dapat melakukan klaim komplain, pastikan Anda mendokumentasikan proses unboxing dari produk yang telah dikirim.</span>
                        </div>
                    </div>
                </div>
            </div>
