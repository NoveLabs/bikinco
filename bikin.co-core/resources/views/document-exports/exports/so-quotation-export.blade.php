            ...
            <ul class="page-list">
                ...
                <li class="list-grid-6">
                    ...
                    <div class="document-info small-padding-left">
                        ...
                        <p>{{ \Carbon\Carbon::parse($orders[0]->created_at)->locale('id')->translatedFormat('l, d F Y') }}</p>
                    </div>
                </li>
                    ...
                    <li class="list-grid-4 text-right">
                        <div class="address-container text-left">
                            <address class="address-title signature-content">
                                <span
                                    class="small-margin-bottom">Yogyakarta, {{ \Carbon\Carbon::parse($orders[0]->created_at)->locale('id')->translatedFormat('l, d F Y') }}</span><br><br>
    ...
    <div class="main-page" page-title="order-summary">
        ...
        <div class="page-body">
            ...
            <div class="order-list">
                <p class="text-default text-bold">Daftar Order Product</p>
                <ul class="page-list">
                        ...
                        @foreach($order_items as $key => $item)
                            <div class="item-list-card default-margin-bottom">
                                <ul class="page-list">
                                    ...
                                    <li class="list-grid-4 text-right">
                                        <div>
                                            <span>{{ formatRupiah($item->sum_product_price) }}</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                        ...
                        <div class="item-list-card summary-sub-item">
                            <ul class="page-list">
                                ...
                                <li class="list-grid-6 text-right">
                                    <div>
                                        <span>{{ formatRupiah($order_items[$key]->sum_product_price) }}</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
            ...
            <hr class="line-separator">
            <div class="order-list">
                <p class="text-default text-bold">Daftar Aksesoris</p>
                <ul class="page-list">
                    @php $data_sum_accs_array = []; @endphp
                    <li class="list-grid-12 default-margin-bottom">
                                ...
                                <ul class="page-list">
                                    <li class="list-grid-4">
                                        <div>
                                            ...
                                            <span
                                                style="font-size: 11pt;">{{ formatRupiah($item->amount) }} / Unit</span>
                                        </div>
                                    </li>
                                    <li class="list-grid-4 text-center">
                                        <div>
                                    ...
                                    <li class="list-grid-4 text-right">
                                        <div>
                                            <span>{{ formatRupiah(($item->amount * $item->qty)) }}</span>
                                        </div>
                                    </li>
                                </ul>
                            </div>
                            @php
                                $data = ($item->amount * $item->qty);
                                array_push($data_sum_accs_array, $data);
                            @endphp
                        @endforeach
                        <div class="item-list-card summary-sub-item">
                            <ul class="page-list">
                                <li class="list-grid-6">
                                    <div>
                                        <span class="text-bold">Subtotal Aksesoris</span>
                                    </div>
                                </li>
                                <li class="list-grid-6 text-right">
                                    <div>
                                        <span>{{ formatRupiah(array_sum($data_sum_accs_array)) }}</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                    ...
                    <li class="list-grid-12 default-margin-bottom">
                        <div class="item-list-card summary-item small-margin-top">
                            <ul class="page-list">
                                ...
                                <li class="list-grid-6 text-right">
                                    <div>
                                        <span>{{ formatRupiah(($orders[0]->total_amount)) }}</span>
                                    </div>
                                </li>
                            </ul>
                        </div>
                                    ...
                                    <li class="list-grid-10" style="padding-left: 2mm;">
                                        <div>
                                            ...
                                            @if($order_items[0]->is_custom_label == 0)
                                                <span class="text-default text-bold">Tanpa Label</span>
                                            @endif
                                            @if($order_items[0]->is_custom_label == 1)
                                                <span class="text-default text-bold">Label Bikin.co</span>
                                            @endif
                                    ...
                                    <li class="list-grid-10" style="padding-left: 2mm;">
                                        <div>
                                            ...
                                            @if($order_items[0]->is_repackaging == 0)
                                                <span class="text-default text-bold">Packaging Standard</span>
                                            @endif
                        ...
                        <div class="data-material-and-specs">
                            ...
                            <table class="page-table table-bordered">
                                ...
                                @foreach($accessories as $key => $item)
                                    ...
                                    @php
                                        $data = ($item->qty * $item->amount);
                                        array_push($subtotal_accs, $data);
                                    @endphp
                                @endforeach
                                <tr style="background-color: lightgrey;">
                                    <td colspan="5">Subtotal Aksesoris</td>
                                    <td>{{ formatRupiah(array_sum($subtotal_accs)) }}</td>
                                </tr>
                                </tbody>
                            </table>
                        </div>
