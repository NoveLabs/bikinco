                        ...
                        <ul class="page-list">
                            ...
                            <li class="list-grid-4 text-left">
                                <div class="address-recipient-section">
                                    <div class="address-container">
                                        <address class="address-title">Dini Kirana</address>
                    ...
                    <div class="page-container">
                        <table class="page-table table-default">
                            ...
                            <tr>
                                <td>0002</td>
                                <td class="text-left">
                                    <div>Tambahan Biaya ukuran 4XL<br>Kaos Team Kantor</div>
                                </td>
                                <td>24</td>
                                <td>10,000</td>
                                <td>240,000</td>
                            ...
                            <div class="page-card no-margin-right">
                                    ...
                                    <ul class="page-list text-left">
                                        ...
                                        <li class="list-grid-12">
                                            <ul class="page-list">
                                                ...
                                                <li class="list-grid-6 text-right">Rp. 1,000,000</li>
                                            </ul>
                                        </li>
                                    </ul>
                                </div>
                                <div class="card-footer official-background">
                                    <ul class="page-list text-left">
                                        <li class="list-grid-12">
                                            <ul class="page-list">
                                                <li class="list-grid-6">Pembayaran DP</li>
                                                <li class="list-grid-6 text-right">Rp. 1,000,000</li>
                                            </ul>
                                        </li>
                                    </ul>
