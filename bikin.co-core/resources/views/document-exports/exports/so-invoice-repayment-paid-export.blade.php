...
@section('document.content')
    <div class="invoice">
        <div class="main-page has-watermark" page-title="invoice-detail">
                                    ...
                                    <div class="page-card no-margin-right">
                                            ...
                                            <ul class="page-list text-left">
                                                ...
                                                <li class="list-grid-12">
                                                    <ul class="page-list">
                                                        ...
                                                        <li class="list-grid-6 text-right">{{ !$orders[0]->discount == null ? formatRupiah(($orders[0]->total_amount - $orders[0]->discount)) : formatRupiah($orders[0]->total_amount + $orders[0]->shipment_amount) }}</li>
                                                    </ul>
                                                </li>
                                                <li class="list-grid-12">
                                                    <ul class="page-list">
                                        ...
                                        <div class="card-footer official-background">
                                            <ul class="page-list text-left">
                                                <li class="list-grid-12">
                                                    <ul class="page-list">
                                                        <li class="list-grid-6">Lunas</li>
                                                        <li class="list-grid-6 text-right">{{ $orders[0]->part_paid_amount == 0 ? formatRupiah(($orders[0]->total_price_rounding - $orders[0]->total_amount)) : formatRupiah(($orders[0]->total_price_rounding)) }}</li>
                                                    </ul>
                                                </li>
                                            </ul>
                                        </div>
