...
<head>
    ...
    <style>
        * {
        ...
        .has-watermark::before {
            ...
            height: 320px;
            position: absolute;
            background: url(http://localhost:8080/bikin.co/public/print_exports/samples/img/logo/company_logo.png) center center no-repeat;
            left: 0;
            top: 10cm;
            bottom: 0;
            right: 0;
    ...
    <title>[ PAID ] - Invoice Pelunasan Product</title>
    @yield('inline_style')
</head>
<body>
