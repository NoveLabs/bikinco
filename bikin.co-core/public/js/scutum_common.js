...
scutum.bundles = {
    ...
    'accounting': ['/js/vendor/accounting.min.js'],
	// https://github.com/jackmoore/autosize
    'autosize': ['/js/vendor/autosize.min.js'],
	// https://github.com/tuupola/jquery_chained
    'chained': ['js/vendor/jquery.chained.min.js'],
    ...
    'flatpickr': ['node_modules/flatpickr/dist/flatpickr.min.js', 'node_modules/flatpickr/dist/plugins/confirmDate/confirmDate.js', 'node_modules/flatpickr/dist/plugins/rangePlugin.js', 'node_modules/flatpickr/dist/flatpickr.min.css'],
    ...
    'select2': ['node_modules/select2/dist/js/select2.min.js', 'node_modules/select2/dist/css/select2.min.css', 'css/plugins/select2.min.css'],
	// https://github.com/rstaib/jquery-steps
    'steps': ['assets/js/vendor/jquery.steps.min.js', 'assets/css/plugins/steps.min.css'],
	// https://github.com/abpetkov/switchery
    'switchery': ['node_modules/switchery/dist/switchery.min.js', 'css/plugins/switchery.min.css'],
	// =========== WYSIWYG
    ...
    'datatables': ['node_modules/datatables.net/js/jquery.dataTables.min.js', 'node_modules/datatables.net-responsive/js/dataTables.responsive.min.js', 'assets/js/vendor/datatables/responsive.uikit.min.js', 'assets/js/vendor/datatables/dataTables.uikit.min.js', 'assets/DataTables/datatables.min.css'],
    'datatables-buttons': ['profile/js/vendor/pdfmake.min.js', 'user/js/vendor/vfs_fonts.js', 'js/vendor/jszip.min.js', 'node_modules/datatables.net-buttons/js/dataTables.buttons.min.js', 'node_modules/datatables.net-buttons/js/buttons.html5.min.js', 'node_modules/datatables.net-buttons/js/buttons.print.min.js'],
    ...
    'handlebars': ['node_modules/handlebars/dist/handlebars.min.js', 'node_modules/handlebars-intl/dist/handlebars-intl.min.js', 'node_modules/handlebars-intl/dist/locale-data/fr.js'],
	...
	// =========== OTHER ASSETS
    'flagsCSS': ['icons/flags/flags.css'],
